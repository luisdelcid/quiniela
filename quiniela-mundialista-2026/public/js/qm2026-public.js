(function($){
  ...
  $(document).on('submit','.qm2026-prediction-form',function(e){
    ...
    $.post(QM2026.ajaxUrl, $f.serialize()+'&action=qm2026_save_prediction&nonce='+QM2026.nonce).done(function(r){ msg($f,r.success?r.data.message:(r.data||'Error'),!!r.success); }).fail(function(xhr){ msg($f,(xhr.responseJSON&&xhr.responseJSON.data)||'Error',false); });
  });
})(jQuery);
